...
function head_content(student_data,year_team){
  ...
  content += '<div  class="col-sm-10"  >\
      <div class="col-sm-12" style="text-align:center">\
        <label><h2>國立虎尾科技大學 '+ year_team[0] +' 學年度第 '+ team +' 學期<br>賃居校外學生輔導訪問記錄表</h2></label>\
      </div>\
      ...
      <div class="col-sm-12 mtop">\
        ...
        <div class="col-sm-4 mtop">\
          <div class="input-group col-sm-12 mtop">\
            ...
            <input id="msg" type="text"  disabled="disabled" class="form-control" value="' + student_data[4] + '"name="msg" placeholder="">\
          </div>\
        </div>\
        <div class="col-sm-3 mtop">\
          <div class="input-group col-sm-12 mtop">\
...
function body_cntent(answer,questiondesign,imagePATH,student_description,teacher_description,student_number){
    var content = "";
    content += '\
    ...
    content +=  '<div class="col-sm-12" style="text-align:center" ><ul class="pagination">\
                  <li class="form_page_li"><a  href="#form_" onclick="get_form(' + '\'next\'' + ')" href="#">Previous</a></li>\
                  <li class="form_page_li"><a href="#form_"  onclick="get_form(' + '\'pre\'' + ')" href="#">Next</a></li>\
                </ul></div>'
    return content;
}
...
//載入學生及房東基本資料填寫欄位
function load_student_form(res,student_data,student_number){ 
      var form_content = ""
      form_content += head_content(student_data,res.year_team);
      form_content += body_cntent(res.answer,res.questiondesign,res.imagePATH,res.student_description,res.teacher_description,student_number);                    
